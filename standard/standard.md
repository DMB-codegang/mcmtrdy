...
4. 限速小于等于40的道岔应尽量不设计于正线
5. 对于限速大于40的道岔，水平半径按照[正线水平半径要求](/standard/standard?id=平面最小曲线半径)建设
...
![复式交分道岔](./double_slip_switches.png)

复式交分道岔虽然可以缩短站场长度，但在MTR中由于轨道节点仅有0°、30°、45°三种方向，因此复式交分道岔的转弯半径难以减小。如需建设复式交分道岔，请留意转弯半径与限速。如果建设速度为200km/h以上的铁路线路，则禁止修建复试道岔。
